...
@export var default_acceleration : float = 1.0 ## A multiplier applied to the player's acceleration, 1.0 is the default value.
@export var default_deceleration : float = 7.0 ## A multiplier applied to the player's deceleration, 7.0 is the default value.
